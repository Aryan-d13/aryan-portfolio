...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    label: 'Content', items: [
      ...
      { id: 'identity-layer', label: 'Working Style', index: '02' },
      { id: 'sections', label: 'Sections', index: '03' },
      { id: 'projects', label: 'Project Case Files', index: '04' },
      { id: 'proof', label: 'Proof Cards', index: '05' },
      { id: 'skills', label: 'Stack', index: '06' },
      { id: 'philosophy', label: 'Philosophy', index: '07' },
      { id: 'human', label: 'Human Layer', index: '08' },
      { id: 'timeline', label: 'Build Log', index: '09' },
  ...
  },
  {
    label: 'Design', items: [
      ...
      { id: 'background', label: 'Background', index: '15' },
      { id: 'motion', label: 'Motion', index: '16' },
      { id: 'layout', label: 'Layout', index: '17' },
    ],
  },
  {
    label: 'System', items: [
      { id: 'lab-modules', label: 'Lab Modules', index: '18' },
      { id: 'seo', label: 'SEO Metadata', index: '19' },
